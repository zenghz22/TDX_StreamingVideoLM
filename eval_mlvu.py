...
if __name__ == "__main__":
    ...
    annontation_path = "/home/zenghanzhang/STC/data/mlvu_zhz_sample5/mlvu_zhz_sample5.json"
    # 加载annotation文件，索引其中的第args.anno_index项字典
    with open(annontation_path, "r") as f:
    ...
    # ── 编码阶段 ──────────────────────────────────────────────────────
    with measure_resources("Encode and Decode", logger=logger, plot_file=args.plot_file) as monitor:
        '''

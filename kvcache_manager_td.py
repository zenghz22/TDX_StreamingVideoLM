...
# ---------------------------------------------------------------------------
# 兼容包装：供旧版 main_td.py 使用 "from kvcache_manager_td import encode_video_managed"
# ---------------------------------------------------------------------------

def encode_video_managed(
    video,
    processor,
    model,
    kv_cache_dir,
    ...
    """
    encode_video 的快捷包装，自动构建 KVCacheManager 并调用 encode_video。
